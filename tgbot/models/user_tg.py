...
class UserTG(User):
    ...
    async def send_photo(self,
        ...
        return await self._execute_telegram_action(self.bot.send_photo,
                                                   photo,
                                                   caption,
                                                   parse_mode,
                                                   caption_entities,
    ...
    async def send_document(self,
        ...
        return await self._execute_telegram_action(self.bot.send_document,
                                                   document,
                                                   thumb,
                                                   caption,
                                                   parse_mode,
    ...
    async def send_chat_action(self,
        ...
        return await self._execute_telegram_action(self.bot.send_chat_action,
                                                   action)
    ...
    async def send_audio(self,
        ...
        return await self._execute_telegram_action(self.bot.send_audio,
                                                   audio,
                                                   caption,
                                                   parse_mode,
                                                   caption_entities,
